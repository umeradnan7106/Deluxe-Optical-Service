...
export default function AdminInventoryPage() {
  ...
  return (
    <div>
      <h1 className="font-['Cormorant_Garamond'] text-3xl text-white font-semibold mb-6">Inventory</h1>
        ...
        {[
          ...
          <button
            ...
            className={`px-4 py-2 rounded text-sm transition-colors ${
              filter === value ? "bg-[#E8670A] text-white" : "bg-[#1a1a1a] text-gray-400 hover:text-white"
            }`}
          >
            {label}
          </button>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading ? (
              ...
              <tr key={item.variant_id} className="border-b border-[#2a2a2a] hover:bg-[#2a2a2a]/30">
                <td className="px-4 py-3 text-white">{item.product_name}</td>
                <td className="px-4 py-3 text-gray-300">{item.color_name}</td>
                <td className="px-4 py-3 text-gray-400 font-mono text-xs">{item.sku_variant || item.sku}</td>
                  ...
                  {editingId === item.variant_id ? (
                    <div className="flex gap-2 items-center">
                      <input
                        ...
                        className="w-20 bg-[#2a2a2a] border border-[#E8670A] text-white text-sm px-2 py-1 rounded"
                        autoFocus
                      />
                    ...
                    <button
                      ...
                      className="text-white hover:text-[#E8670A] transition-colors font-mono"
                    >
                      {item.stock}
                    </button>
                  )}
