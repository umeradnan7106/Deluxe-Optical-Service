        ...
        <div className="max-w-[1500px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-['Cormorant_Garamond'] text-4xl text-gray-900 font-semibold mb-6">
            ...
            <div className="relative aspect-square rounded-xl overflow-hidden bg-gray-100 flex items-center justify-center text-gray-400 text-sm">
              <Image
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-[1500px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TEAM.map(({ name, desc }) => (
              <div key={name} className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                <h3 className="text-gray-900 font-semibold text-lg mb-3">{name}</h3>
