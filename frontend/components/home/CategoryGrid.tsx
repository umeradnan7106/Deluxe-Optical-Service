  ...
  return (
    <section className="max-w-[1500px] mx-auto px-6 py-12">
      <div className="mb-6">
        ...
        <h2 className="font-['Cormorant_Garamond'] text-3xl text-white font-semibold">Find Your Style</h2>
      </div>
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        {CATS.map(({ label, href, Icon }) => (
          <Link key={label} href={href} className="group">
            <div className="bg-[#1a1a1a] rounded-lg p-6 flex flex-col items-center text-center gap-3 hover:ring-1 hover:ring-[#E8670A] transition-all">
